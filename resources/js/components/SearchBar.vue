<template>
    <div>
        ...
        <div v-if="focus" @click="focus = false; serchResults = [];" class="bg-black opacity-0 absolute right-0 left-0 top-0 bottom-0 z-10"></div>
        ...
        <div id="search_bar" class="relative z-10">
            ...
            <input type="text" v-bind:placeholder="selectedTagNames" id="searchTerm" v-model="searchTerm" @input="search" @focus="focus = true" class="w-64 bg-gray-200 border border-gray-400 pl-8 pr-3 py-1 rounded-full text-sm 
            ...
            <div v-if="focus" class="absolute bg-blue-900 text-white rounded-lg p-4 w-64 opacity-75 right-0 mr-2 shadow z-20">
                ...
                <div v-for="result in serchResults">
